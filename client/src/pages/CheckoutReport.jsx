...
const CheckoutReport = () => {
  ...
  const generateReport = () => {
    setLoading(true); // Show loader before generating report
    ...
    html2canvas(input, { scale, backgroundColor: null })
      .then((canvas) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex justify-center items-start min-h-screen p-10 gap-x-5 bg-stone-700">
        <Link
          to="/shop"
          id="backHome"
          className="flex items-center justify-center h-12 w-24 bg-white rounded-md text-gray-800 tracking-wide transition-all duration-200 cursor-pointer border-none hover:shadow-[9px_9px_33px_rgba(209,209,209,1),_-9px_-9px_33px_rgba(55,0,5,1)] hover:transform hover:-translate-y-0.5"
        >
          <svg
